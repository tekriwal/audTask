%V6, 7/19/20; AT added some subfxs
...
% c = cell2mat(masterspikestruct_V2.clustfileIndex);
% if caselabelON == 1
%     text(inputFR'+dx, inputWvWdth'+dy, c);
% end
...
%% AT 6/11/20; it is going to be necessary to do some broader comparisons before getting into DAN vs GABA differences
% looks good!
close all
...
hold on
scatter(xaxis_onPairedIS(:),inputinfo1(:), szz,  [.5 .5 .5], 'filled', 'MarkerFaceAlpha', 2/8, 'MarkerEdgeAlpha', 1)
...
hold on
scatter(.75, median(inputinfo1), szz*2,'MarkerFaceColor', 'k','MarkerEdgeColor', 'k', 'MarkerFaceAlpha',6/8)
hold on

scatter(1.25, median(inputinfo2), szz*2,'MarkerFaceColor', 'k','MarkerEdgeColor', 'k', 'MarkerFaceAlpha',6/8)

hold on
plot([.75 1.25], [median(inputinfo1)  median(inputinfo2)], 'Color', 'k', 'LineWidth', 3);
...
if violinsON == 1
    ...
    %
    % hold on
    % scatter(1, mean(input1), szz*2,'MarkerFaceColor', 'k','MarkerEdgeColor', 'k', 'MarkerFaceAlpha',6/8)
    % hold on
    %
    % scatter(1.05, mean(input2), szz*2,'MarkerFaceColor', 'k','MarkerEdgeColor', 'k', 'MarkerFaceAlpha',6/8)
    %
    % hold on
    % plot([1 1.05], [mean(input1)  mean(input2)], 'Color', 'k', 'LineWidth', 3);
    %
    %
    % % set(gca, 'YTick', [-1 -0.5 0 0.5 1]);

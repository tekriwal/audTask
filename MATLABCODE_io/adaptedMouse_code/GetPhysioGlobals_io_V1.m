...
function GetPhysioGlobals_io_V1

%%% ESTABLISH THE GLOBAL VARIABLES
%AT so we first need to define what the parameters names are. AFTER, we can
%then set these variable names to actual values. Once we do that, we should
%be able to call these variables from whereever
...
TRIAL_EVENTS.trialStart_times = 1;
TRIAL_EVENTS.upPressed_times = 2;
TRIAL_EVENTS.stimDelivered_times = 3;
TRIAL_EVENTS.goCue_times = 4;
TRIAL_EVENTS.leftUP_times = 5;
TRIAL_EVENTS.submitsResponse_times = 6;
TRIAL_EVENTS.feedback_times = 7;

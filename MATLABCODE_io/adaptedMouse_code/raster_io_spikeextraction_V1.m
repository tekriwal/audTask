...
function [ref_spike_times, trial_inds, plot_handles, ref_spike_times_bursting] =...
    raster_io_spikeextraction_V1(NUM_TRIALS_TO_PLOT, spike_times, trial_start_times, event_times, window, secondary_event_times, ref_time_start_offset, ref_time_end_offset)

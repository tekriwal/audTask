...
%ATinputs of caseNumb = 10, spikeFile = 'spike1', and clust = 1, have good
%output
if nargin == 0
    caseNumb = 10;
    spikeFile = 'spike1';
...
%     align_ind1 = 4;
   ...
   prefAnalysis = 1;
    ...
    %for align_ind1 = 2; -1.5 to 1 I used 60
    %for align_ind1 = 4; -2  to 1 I used 70
    %for align_ind1 = 4; -.5  to 4.5 I used 85
    %for align_ind1 = 7; -1  to 1 I used 45
...
onlyQuickTrials = 1; %when set to 1, means that raster plots trials that get done in < 5 seconds
onlyQuickTrialsThresh = 7;
...
ipsi_COLOR = [.5 .5 .5]; %grey
contra_COLOR = [.5 .5 .5]; %grey

ipsi_COLOR = [0 0 0]; %black
contra_COLOR = [0 0 0]; %black
...
if onlyQuickTrials == 1
    trial_inds = trial_inds(feedback_times<onlyQuickTrialsThresh);
    trial_start_times = taskbase_io.events.trialStart(trial_inds)';
...
if strcmp(surgerySide, 'L')
    p1 = plot(ref_psth_info.L.choice.event1.smooth_psth, 'Color', ipsi_COLOR, 'LineStyle', ipsi_STYLE);
    
elseif strcmp(surgerySide, 'R')
    p1 = plot(ref_psth_info.L.choice.event1.smooth_psth, 'Color', contra_COLOR, 'LineStyle', contra_STYLE);
end%title('Stimulus guided');
%
...
if strcmp(surgerySide, 'L')
    p3 = plot(ref_psth_info.R.choice.event1.smooth_psth, 'Color', contra_COLOR, 'LineStyle', contra_STYLE);
    
elseif strcmp(surgerySide, 'R')
    p3 = plot(ref_psth_info.R.choice.event1.smooth_psth, 'Color', ipsi_COLOR, 'LineStyle', ipsi_STYLE);
end%title('Stimulus guided');
%
...
if strcmp(surgerySide, 'L')
    p2 = plot(ref_psth_info.L.nochoice.event1.smooth_psth, 'Color', ipsi_COLOR, 'LineStyle', ipsi_STYLE);
    
elseif strcmp(surgerySide, 'R')
    p2 = plot(ref_psth_info.L.nochoice.event1.smooth_psth, 'Color', contra_COLOR, 'LineStyle', contra_STYLE);
end%title('Stimulus guided');
%
% p1 = plot(ref_psth_info.L.choice.event1.smooth_psth, 'Color', ipsi_COLOR, 'LineStyle', CHOICE_STYLE);
% % p2 = plot(ref_psth_info.L.nochoice.event1.smooth_psth, 'Color', L_COLOR, 'LineStyle', NOCHOICE_STYLE);

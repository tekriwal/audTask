% 2/17/20
%% AT's copy, updated january 2018
...
% GF 8/3/16: changed from using fspecial to normpdf because fspecial is in
% the imaging toolbox (and not necessarily available)
...
smoothing_filter = normpdf([1:RESOLUTION], (RESOLUTION / 2), smoothing_factor); % IF THIS LINE IS CHANGED, THE PADDING IN RASTER.M AND PSTH.M MUST ALSO BE CHANGED

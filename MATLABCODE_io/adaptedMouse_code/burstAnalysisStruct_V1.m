...
function [h1, fig_handle] = burstAnalysisStruct_V1(caseNumb, spikeFile, clust, align_ind1, saveFig)
...
figuresdir = fullfile('/Users','andytek','Box','Auditory_task_SNr','Data','generated_analyses','burstAnalysis', caseName); %set this to be 1,2, or 3; note that only a few of the spike recordings are multi-cluster
...
filename2 = (['/burstStruct', caseName, spikeFile, clustname, 'wholetrial']);
if saveFig == 1

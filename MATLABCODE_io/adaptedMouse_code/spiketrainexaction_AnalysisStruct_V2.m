...
function [h1, fig_handle] = spiketrainexaction_AnalysisStruct_V2(caseNumb, spikeFile, clust, saveFig)
...
spiketrainStrct.features = spk_file.spikeDATA.features;  
...
[ref_spike_times, trial_inds, plot_handle, spikestruct] = raster_io_spikeextraction_V2(NUM_TRIALS_TO_PLOT, spike_times, trialStart_times',...
    epochInfo, window_event1,[trialStart_times; upPressed_times; stimDelivered_times; goCue_times; leftUP_times; submitsResponse_times; feedback_times]);

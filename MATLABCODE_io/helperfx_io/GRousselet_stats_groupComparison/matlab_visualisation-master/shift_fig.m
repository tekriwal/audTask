%AT editting beginning on 1/16/19

function shift_fig(xd, yd, delta, deltaCI,x,x1,y,y1,ind,med)
...
set(gca,'FontSize',14,'YTick',[1 2],'YTickLabel',{x1;y1})
...
set(gcf,'Position',[pos(1)*(1/5),pos(2)*(1/5),pos(3)*1.5,pos(4)*2.5])

saveas(gcf,[x1, 'compared to', y1,'.jpg'])

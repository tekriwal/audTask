%V1 for post created 6/28/20, building off of previous work done on post io
%import

%Note, you'll want to run import_excelData_auditoryTask_V1 before this and
%use that output for this input

function [inputmatrix1, rsp_struct1] = import_behavior_preIO_auditoryTask_V1(caseInfo_table, selectInputs)
%example use: 
...
behaviorfolder = caseInfo_table.("Name of subfolder with pre IO behavioral data on box.com  ");
...
inputmatrix_filePath = fullfile('Users','andytek','Box','Auditory_task_SNr','Data','pre_io_behavior_data', behaviorfolder, inputmatrix_name1);
inputmatrix_rspPath = fullfile('Users','andytek','Box','Auditory_task_SNr','Data','pre_io_behavior_data', behaviorfolder, rsp_name1);

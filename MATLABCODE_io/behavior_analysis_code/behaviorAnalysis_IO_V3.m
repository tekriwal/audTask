...
for i = 1:11
    ...
    [pvalue,outcome] = stats_subfx2tailed(SG_indivRxntime,IS_indivRxntime, 'notpaired');
...
%     paraORnonpara_allrxnTime{i} = paraORnonpara;
    ...
    [pvalue,outcome] = stats_subfx2tailed(SG_indivRxntimewholetrial,IS_indivRxntimewholetrial, 'notpaired');
...
%     paraORnonpara_allrxnTimewholetrial{i} = paraORnonpara;
    ...
    [pvalue,outcome] = stats_subfx2tailed(SG_indivRxntimeleftUPtillFeedback,IS_indivRxntimeleftUPtillFeedback, 'notpaired');
...
%     paraORnonpara_allrxnTimeleftUPtillFeedback{i} = paraORnonpara;
    ...
    [pvalue,outcome] = stats_subfx2tailed(SG_latencytoMove,IS_latencytoMove, 'notpaired');
...
%     paraORnonpara_latencytoMove{i} = paraORnonpara;
    ...
    [pvalue,outcome] = stats_subfx2tailed(SG_nonrxntimes,IS_nonrxntimes, 'notpaired');
...
%
%
%     [pvalue,outcome] = stats_subfx1tailed(SG_indivRxntime,IS_indivRxntime);

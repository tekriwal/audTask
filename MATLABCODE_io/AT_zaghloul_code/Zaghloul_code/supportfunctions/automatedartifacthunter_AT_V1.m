...
function [events_all_clean, powerMat_all_clean, phaseMat_all_clean]=automatedartifacthunter_AT_V1(filename, events_all, powerMat_all, phaseMat_all, time, freqs, Zthresh, freq_indexes, plotdata)

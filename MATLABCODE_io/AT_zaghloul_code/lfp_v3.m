...
title(strcat(['Case#: ' mat2str(caseNumb),'  LFP#: ' mat2str(LFP),'  Epoch:' mat2str(epoch), '  All bands']))
...
% l{1} = 'Significant FR decrease'; l{2} = 'No FR change'; l{3} =  'Significance FR increase';
title(strcat(['Case#: ' mat2str(caseNumb),'  LFP#: ' mat2str(LFP),'  Epoch:' mat2str(epoch), '  All bands, except Delta']))
% if strcmp(subfolder_name, 'MI')
%     legend(h,l, 'Location', 'NorthWest');
% else
    legend(h,l, 'Location', 'NorthEast');

function varargout = Clusterizer_v11(varargin)
% CLUSTERIZER_V11 MATLAB code for Clusterizer_v11.fig
%      CLUSTERIZER_V11, by itself, creates a new CLUSTERIZER_V11 or raises the existing
%      singleton*.
%
%      H = CLUSTERIZER_V11 returns the handle to a new CLUSTERIZER_V11 or the handle to
%      the existing singleton*.
%
%      CLUSTERIZER_V11('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CLUSTERIZER_V11.M with the given input arguments.
%
%      CLUSTERIZER_V11('Property','Value',...) creates a new CLUSTERIZER_V11 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Clusterizer_v11_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Clusterizer_v11_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Clusterizer_v11

% Last Modified by GUIDE v2.5 13-Feb-2018 17:04:16

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Clusterizer_v11_OpeningFcn, ...
    'gui_OutputFcn',  @Clusterizer_v11_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before Clusterizer_v11 is made visible.
function Clusterizer_v11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Clusterizer_v11 (see VARARGIN)

% Choose default command line output for Clusterizer_v11
...
% UIWAIT makes Clusterizer_v11 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = Clusterizer_v11_OutputFcn(hObject, eventdata, handles)

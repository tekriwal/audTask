function varargout = Clusterizer_v10_a(varargin)
% CLUSTERIZER_V10_A MATLAB code for Clusterizer_v10_a.fig
%      CLUSTERIZER_V10_A, by itself, creates a new CLUSTERIZER_V10_A or raises the existing
%      singleton*.
%
%      H = CLUSTERIZER_V10_A returns the handle to a new CLUSTERIZER_V10_A or the handle to
%      the existing singleton*.
%
%      CLUSTERIZER_V10_A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CLUSTERIZER_V10_A.M with the given input arguments.
%
%      CLUSTERIZER_V10_A('Property','Value',...) creates a new CLUSTERIZER_V10_A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Clusterizer_v10_a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Clusterizer_v10_a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Clusterizer_v10_a

% Last Modified by GUIDE v2.5 06-Feb-2018 10:57:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Clusterizer_v10_a_OpeningFcn, ...
    'gui_OutputFcn',  @Clusterizer_v10_a_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before Clusterizer_v10_a is made visible.
function Clusterizer_v10_a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Clusterizer_v10_a (see VARARGIN)

% Choose default command line output for Clusterizer_v10_a
...
% UIWAIT makes Clusterizer_v10_a wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = Clusterizer_v10_a_OutputFcn(hObject, eventdata, handles)
...
switch stage
    ...
    case 'new'
        ...
        minT = (mSamp + (sdSamp*15))*-1;
        maxT = mSamp + (sdSamp*15);

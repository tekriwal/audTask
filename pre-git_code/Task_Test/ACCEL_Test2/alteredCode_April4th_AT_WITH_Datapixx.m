function [rsp] = alteredCode_April4th_AT_WITH_Datapixx()
dbstop if error

%3/19

%Exact version used for 11/27, 2nd side of repeat pt but fist time data did
%not save out as struct from Mat;ab nor were there TTLs

% as of 11/19/17 at 5:10PM, this is the uneddited version of code to use
% tomorrow, UNLESS some new version works better after editing Arduino
% calls

%Point is to prep code for Arduino querying

% As of 10/18/17 Noon; this code functions reasonably well on Mac, running
...
% load('input_matrix_rndm_March19.mat', 'input_matrix_rndm') %full input
